...
const zhTWPresentationMessages: Readonly<Record<string, string>> = {
	...
	'Relations': 'Relations',
	'Dependencies views': 'Dependencies 檢視',
	'Used by': '被誰使用',
	'Depends on': '依賴於',
	'Focused member': '聚焦的 member',
	'Focused widget': '聚焦的 widget',
	'No incoming dependencies': '沒有 incoming dependencies',
	'No outgoing dependencies': '沒有 outgoing dependencies',
	'Internal dependencies': '內部 dependencies',
	'No internal dependencies between members': 'members 之間沒有內部 dependencies',
	'No focus selected': '尚未選取 focus',
	'Select a widget or member from Preview Inspect, Blueprint, Runtime, or Graph to inspect its dependencies.': '請從 Preview Inspect、Blueprint、Runtime 或 Graph 選取 widget 或 member，以檢視其 dependencies。',
	'How to select focus:': '如何選取 focus：',
	'Turn on Inspect and click a widget': '開啟 Inspect 並點選 widget',
	'Click a node or member in the tree': '在 tree 中點選節點或 member',
	'Select a state, property, or method row': '選取 state、property 或 method 列',
	'Click a widget cluster or member node': '點選 widget cluster 或 member 節點',
	'this widget': '此 widget',
	'Widget:': 'Widget：',
	'Used by:': '被誰使用：',
	'Depends on:': '依賴於：',
	'members': '個 members',
	...
	'No widget is focused. Select a widget in Preview (Inspect mode), Blueprint, or Dependencies to see its implementation here.': '目前沒有聚焦的 widget。請從 Preview（檢視模式）、Blueprint 或 Dependencies 選取 widget，即可在這裡查看實作。',
	'No widget is focused. Select a widget in Preview (Inspect mode), Blueprint, or Dependencies, or browse Registered plugins without selecting an instance.': '目前沒有聚焦的 widget。可從 Preview（檢視模式）、Blueprint 或 Dependencies 選取 widget，或直接瀏覽已註冊 plugins 而不選取 instance。',
