/**
 * The persistent ELK layout Worker (issue #13 Phase 5 "Dependency Graph worker loading" comment).
 *
 ...
 * be* the elkjs worker, with zero protocol code of our own to keep the worker itself thin (issue #13
